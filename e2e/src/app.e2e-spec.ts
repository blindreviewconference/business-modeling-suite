...
describe('workspace-project App', () => {
  ...
  it('should display application name', async () => {
    ...
    expect(await page.getNavbarBrand()).toEqual('Business Modeling Suite');
  });
  ...
  describe('when adding an expert model', () => {
    ...
    afterAll(async () => {
      ...
      await browser.executeScript('window.indexedDB.deleteDatabase("_pouch_business-modeling-suite");');
